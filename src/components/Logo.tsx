  ...
  return (
    <div className={`relative ${className}`} style={{ width, height }}>
      ...
      <div className="absolute" style={{ left: 0, right: 0, top: 0, bottom: '46.48%' }}>
        <img alt="" className="absolute inset-0 w-full h-full block" src="/WWF-Cobien/assets/logo-group-1.png" />
      </div>
      {/* Group 2 — bottom ~48% */}
      <div className="absolute" style={{ left: '0.87%', right: '13.05%', top: '51.54%', bottom: 0 }}>
        <img alt="" className="absolute inset-0 w-full h-full block" src="/WWF-Cobien/assets/logo-group-2.png" />
      </div>
    </div>
  );
}
